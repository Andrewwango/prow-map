...
class Converter(object):
    ...
    def _gpx_to_dict(self, lats_colname="latitude", longs_colname="longitude", times_colname="time", alts_colname="altitude", trackno_colname="trackid", i=None):
        ...
        if any(times) and any(alts):
            ...
            return {trackno_colname: ts, times_colname: times, lats_colname: lats, longs_colname: longs}
        elif any(alts):
            return {trackno_colname: ts, lats_colname: lats, longs_colname: longs, alts_colname: alts}
        else:
            return {trackno_colname: ts, lats_colname: lats, longs_colname: longs}
    ...
    def gpx_to_csv(self, lats_colname="latitude", longs_colname="longitude", times_colname="time", alts_colname="altitude", trackno_colname="trackid", output_file=None):
        """
